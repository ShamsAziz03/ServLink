...
const CategoryPage = () => {
  ...
  const fetchcategoriesData = async () => {
    try {
      const response = await fetch(
        "http://192.168.1.14:5000/categoryPage/categories"
      );
  ...
  const fetchServicesData = async () => {
    try {
      const response = await fetch(
        `http://192.168.1.14:5000/categoryPage/services/${activeCategory}`
      );
      const fetchedData = await response.json();
  ...
  const fetchFeedbackData = async () => {
    try {
      const response = await fetch(
        `http://192.168.1.14:5000/categoryPage/feedback/${activeCategory}`
      );
      const fetchedData = await response.json();
