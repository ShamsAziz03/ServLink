...
const home = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http:/192.168.1.14:5000/homeInfo/categories");
  ...
  const fetchOffers = async () => {
    try {
      const response = await fetch("http://192.168.1.14:5000/homeInfo/offers");
  ...
  const fetchMostBooked = async () => {
    try {
      const response = await fetch("http://192.168.1.14:5000/homeInfo/mostBooked");
      const fetchedData = await response.json();
