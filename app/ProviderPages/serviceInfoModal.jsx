...
const ServiceInfoModal = ({ visible, onClose, service }) => {
  ...
  const fetchFeedbacks = async () => {
    const result = await fetch(
      `http://192.168.1.12:5000/serviceProviderServiceList/getProviderServiceFeedbacks/${service.Provider_Services_id}`
    );
  ...
  const fetchAvgRating = async () => {
    const result = await fetch(
      `http://192.168.1.12:5000/serviceProviderServiceList/getProviderServiceAvgRating/${service.Provider_Services_id}`
    );
